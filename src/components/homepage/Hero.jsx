  ...
  return (
    ...
    >
      <div className="z-10 flex flex-col  w-full items-center text-title 2xl:text-[10vw] 2xl:space-y-16 font-bold  uppercase text-accent-300">
        <div className="title 2xl:py-16 sm:py-0 py-5">
          {/* Learn more about useRef */}
          <h1
            ref={(el) => (titles.current[0] = el)}
            className="translate-y-96 overflow-visible text-4xl sm:text-8xl"
          >
            Hey, I&apos;m Ratnakar
          </h1>
        </div>
        <div className=" title 2xl:py-16 sm:py-0 py-5">
          <h1
            ...
            className="translate-y-96 font-outline-3 md:font-outline-4 text-transparent overflow-visible text-4xl sm:text-8xl"
          >
            Hey, I&apos;m Ratnakar
          </h1>
        </div>
        <div className=" title 2xl:py-16 sm:py-0 py-5">
          <h1
            ...
            className="translate-y-96 text-4xl sm:text-8xl"
          >
            Hey, I&apos;m Ratnakar
          </h1>
        </div>
      ...
      <div
        ref={imgContainer}
        className="absolute mx-auto  w-[43%] overflow-hidden rounded-md"
      >
        <img
          ref={img}
