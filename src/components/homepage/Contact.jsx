...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contactSection}
        className="mt-10 flex flex-col gap-0 sm:gap-20 md:grid md:grid-cols-6 md:px-12"
      >
        <div className="col-span-4">
          <h3
            ref={heading}
            className="max-w-lg 2xl:max-w-3xl text-heading-3 2xl:text-7xl font-semibold leading-tight translate-y-10 opacity-0 sm:py-6"
          >
            Have an awesome idea? Let&apos;s bring it to life.
          </h3>
          <p
            ref={body}
            className="mt-4 max-w-md 2xl:max-w-2xl text-body-2 2xl:text-4xl text-accent-100 translate-y-10 opacity-0 sm:py-6"
          >
            I am accepting new projects starting from January 2024.
          </p>
          {/* <form
            name="contact"
            action="/contact"
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1 sm:space-y-10">
          <div className="space-y-3 mt-5 ">
            <h4 className="text-body-1 2xl:text-4xl font-semibold">
              Contact Details
            </h4>
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-2xl">
              <a
                href="mailto:ratnakarmishra623@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>ratnakarmishra623@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://github.com/Rtanakar"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/ratnakar-mishra-506a48231/"
